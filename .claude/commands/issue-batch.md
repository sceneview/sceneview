...
The validated operating model (formalized 2026-05-15; rigor layer adopted from the
`pm-tools` issue-queue model 2026-06-02) is:
...
(the part adopted from pm-tools). The autonomy is *higher* here than in pm-tools because
SceneView is the maintainer's own low-personal-risk repo: auto-merge on **all** platforms,
...
Adopted from the `pm-tools` issue-queue model and calibrated for SceneView's higher autonomy.
