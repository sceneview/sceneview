...
object DemoPreviews {
    ...
    private val previews: Map<String, PreviewPair> = mapOf(
        ...
        "ar-rooftop" to PreviewPair(R.drawable.preview_ar_rooftop_light, R.drawable.preview_ar_rooftop_dark),
        ...
        "ar-terrain" to PreviewPair(R.drawable.preview_ar_terrain_light, R.drawable.preview_ar_terrain_dark),
        ...
        "fog" to PreviewPair(R.drawable.preview_fog_light, R.drawable.preview_fog_dark),
