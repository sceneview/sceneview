...
| iOS (`appstore-screenshots/`) | 2 + 2 | `model-viewer · dynamic-sky` — #2896 dropped the other four; both remaining frames predate #2897, so **re-capture before dispatching `app-store-screenshots.yml`** (see that directory's README) |
