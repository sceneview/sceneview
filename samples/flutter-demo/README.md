...
| `onTap` | `SceneView` (3D): Android and iOS, reporting the tapped model's file base name (iOS fixed in [#3045](https://github.com/sceneview/sceneview/issues/3045): Flutter platform-view gesture policy + a manual raycast). `ARSceneView`: Android only — SceneViewSwift's `ARSceneView` exposes no entity hit-test hook ([#2051](https://github.com/sceneview/sceneview/issues/2051)) |
