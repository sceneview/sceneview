 ...
 * [worldPosition] is **behind the camera** (behind the near plane). A behind-camera point has no
 ...
 * corner crossed the near plane. Always handle the `null` case: skip the point rather than draw at
 * a bogus pixel.
 *
 ...
 * or [worldPosition] is behind the near plane.
 * (0 = left, View Width = right)
 * (0 = top, View Height = bottom)
 * Screen space is in Android device screen coordinates
 */
