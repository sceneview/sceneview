...
- ✅ **Batch-reviewed 4 non-mine perf PRs** (Thomas-requested): #2286 MERGE, #2281 MERGE-WITH-NITS, #2282 MERGE-WITH-NITS, #2280 MERGE-WITH-NITS (+ flagged the #2280↔#2289 `onFrame` overlap on the PR). **#2280/#2286/#2282 since merged to main** + demo Batch 2 (#2290).
- ✅ **sync-versions 0 MISMATCH** (3 expected WARNs), main CI green, AI skills ✅, website OK.

### Followups for next session

1. **MERGE the open perf PRs** — mine: **#2289** (slerp, green/mergeable), **#2291** (AR batching, green/conflict-free); parallel: **#2281** (Manipulator cache, reviewed MERGE-WITH-NITS). Then more perf-umbrella children (#2266/#2267/#2268/#2274/#2277/#2278) are unclaimed and ready to pick up. NOTE: before claiming a perf issue, check existing open PRs' **diffs** (not just issue links) — #2280 had quietly folded #2265's single-read into its scope, causing the #2289 conflict.
