...
- Use `SceneView { }` for 3D-only scenes (`io.github.sceneview:sceneview:4.11.0`)
- Use `ARSceneView { }` for augmented reality (`io.github.sceneview:arsceneview:4.11.0`)
...
### Current state (last updated: 2026-05-20 evening, session vibrant-shtern-147a5c — v4.11.0 SHIPPED + store-deploy correctness sweep)
