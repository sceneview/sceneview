...
### Current state (last updated: 2026-05-31, session pedantic-robinson — macOS #2252 RESOLVED + perf umbrella #2263 FULLY CLOSED)

- 🚀 **v4.16.10 RELEASED & VERIFIED** — Maven Central ✅, npm ✅, Play Store ✅, iOS TestFlight ✅, GitHub Release ✅, website ✅.
...
- ✅ **main CI green**, **0 open perf issues**, sync-versions 0 MISMATCH (3 expected WARNs), main checkout clean, merged worktrees pruned.

### Followups for next session

1. **[#2300](https://github.com/sceneview/sceneview/issues/2300) claim-race process gap** — parallel sessions duplicate-implemented the same issue 3× this session (#2265↔#2280, #2267↔#2294). Proposes: before claiming, grep open-PR *diffs* (not just issue links). 
