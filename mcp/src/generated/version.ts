...
export const PACKAGE_VERSION = "4.1.0" as const;
export const LATEST_SCENEVIEW_RELEASE = "4.41.0" as const;
...
export const LATEST_FLUTTER_PUB_RELEASE = "4.39.0" as const;
