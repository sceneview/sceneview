...
The 7 interior tools are also exposed (along with sceneview-mcp + automotive/gaming/healthcare/rerun verticals and the gateway's widget tool — 67 tools total) on the shared SceneView gateway:
