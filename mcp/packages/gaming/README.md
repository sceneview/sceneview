...
The 7 gaming tools are also exposed (along with sceneview-mcp + automotive/healthcare/interior/rerun verticals, `view_3d_model` included — 67 tools total) on the shared SceneView gateway:
