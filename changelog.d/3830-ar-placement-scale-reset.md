...
- **AR Placement demo: real thumbnails in the model tray, and a tap-to-reset scale read-out ([#3830](https://github.com/sceneview/sceneview/issues/3830)).** The "Pick a model" tray showed a generic cube glyph for every
