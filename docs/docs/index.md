...
<div class="sv-stat">
<span class="sv-stat-number">v4.16.6</span>
...
=== "Kotlin (Android)"
    ...
    ```kotlin
    // build.gradle: implementation("io.github.sceneview:sceneview:4.16.6")
...
=== "Swift (iOS / macOS / visionOS)"
    ...
    ```swift
    // Package.swift: .package(url: "https://github.com/sceneview/sceneview", from: "4.16.6")
...
=== "Android (3D + AR)"
    ...
    // build.gradle.kts
    dependencies {
        implementation("io.github.sceneview:arsceneview:4.16.6")
    }
    ```
