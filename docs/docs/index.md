...
<div class="sv-stat">
<span class="sv-stat-number">v4.13.0</span>
...
=== "Kotlin (Android)"
    ...
    ```kotlin
    // build.gradle: implementation("io.github.sceneview:sceneview:4.13.0")
...
=== "Swift (iOS / macOS / visionOS)"
    ...
    ```swift
    // Package.swift: .package(url: "https://github.com/sceneview/sceneview", from: "4.13.0")
...
=== "Web (JavaScript)"
    ...
    <script src="https://cdn.jsdelivr.net/npm/sceneview-web@4.13.0/sceneview-web.js"></script>
...
=== "Android (3D)"
    ...
    // build.gradle.kts
    dependencies {
        implementation("io.github.sceneview:sceneview:4.13.0")
    }
    ```
...
=== "Android (3D + AR)"
    ...
    // build.gradle.kts
    dependencies {
        implementation("io.github.sceneview:arsceneview:4.13.0")
    }
    ```
...
=== "iOS / macOS / visionOS"
    ...
    .package(url: "https://github.com/sceneview/sceneview", from: "4.13.0")
    ```
