...
```bash
./tools/try-demo.sh --sample android-demo       # Full showcase (54 demos: 19 non-AR + 35 AR)
...
<h3>Android Demo</h3>
<p>Full showcase: 4 tabs, 54 interactive demos, 46+ node types, animations, physics, post-processing.</p>
