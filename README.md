...
[![Flutter](https://img.shields.io/badge/Flutter-v4.33.0-02569B?logo=flutter)](https://github.com/sceneview/sceneview/tree/main/flutter)
[![React Native](https://img.shields.io/badge/React%20Native-v4.33.0-61DAFB?logo=react)](https://github.com/sceneview/sceneview/tree/main/react-native)
...
```kotlin
dependencies {
    implementation("io.github.sceneview:sceneview:4.33.0")     // 3D
    implementation("io.github.sceneview:arsceneview:4.33.0")   // AR (includes 3D)
}
```
...
**Install:** `https://github.com/sceneview/sceneview.git` (SPM, from 4.33.0)
