...
[![Flutter](https://img.shields.io/badge/Flutter-v4.12.0-02569B?logo=flutter)](https://github.com/sceneview/sceneview/tree/main/flutter)
[![React Native](https://img.shields.io/badge/React%20Native-v4.12.0-61DAFB?logo=react)](https://github.com/sceneview/sceneview/tree/main/react-native)
...
<script src="https://cdn.jsdelivr.net/gh/sceneview/sceneview@v4.12.0/website-static/js/filament/filament.js"></script>
<script src="https://cdn.jsdelivr.net/gh/sceneview/sceneview@v4.12.0/website-static/js/sceneview.js"></script>
...
dependencies {
    ...
    implementation("io.github.sceneview:arsceneview:4.12.0")   // AR (includes 3D)
}
```

**iOS / macOS / visionOS** (Swift Package Manager):
```
https://github.com/sceneview/sceneview.git  (from: 4.12.0)
```
...
```kotlin
dependencies {
    implementation("io.github.sceneview:sceneview-web:4.12.0")
}
```
...
**Install:** `https://github.com/sceneview/sceneview.git` (SPM, from 4.12.0)
...
- **39+ node types** as declarative composables
