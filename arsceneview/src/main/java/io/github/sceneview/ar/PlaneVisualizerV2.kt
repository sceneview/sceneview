...
/**
 * Renders a single ARCore Plane using native Filament geometry — V2 skeleton.
 *
 * Behaviourally identical to [PlaneVisualizer] (V1) today. Will gain depth-driven
 * tessellation and displacement in PR #2 of the
