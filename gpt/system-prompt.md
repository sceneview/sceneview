...
- Android: `io.github.sceneview:sceneview:4.30.0` (3D) / `io.github.sceneview:arsceneview:4.30.0` (AR)
- Apple: SPM `https://github.com/sceneview/sceneview.git` (from: "4.30.0"))
- Web: `npm install sceneview-web@4.30.0` (also `<script src="https://cdn.jsdelivr.net/npm/sceneview-web@4.30.0/sceneview-web.js">`)
- MCP: `npx sceneview-mcp` (latest 4.0.16) — adds 31 AI tools
