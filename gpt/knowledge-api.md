...
Package: `sceneview-web` v4.29.0 — npm `sceneview-web`
...
<script src="https://cdn.jsdelivr.net/npm/sceneview-web@4.29.0/sceneview-web.js"></script>
```
...
```swift
.package(url: "https://github.com/sceneview/sceneview.git", from: "4.29.0")
```
